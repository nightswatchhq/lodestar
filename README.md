...
| `GITHUB_TOKEN` | GitHub PAT for the Intel Feed (forum/GIP data) and the `/support` archive. Unauthenticated GitHub allows 60 requests an hour per IP, which both routes exhaust on a busy day | Yes |
