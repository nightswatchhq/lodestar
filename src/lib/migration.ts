...
export const MIGRATED: readonly string[] = [
  ...
  '/api/indexer/*/pnl',
  '/api/indexer/*/qos',
  '/api/indexer/*/qos-deployments',
  '/api/indexer/*/qos-score',
  '/api/indexer/*/revenue',
  '/api/indexer/*/trends',
  '/api/indexers',
...
export const BACKEND_ONLY: readonly string[] = [
  ...
  '/api/indexer/[address]/qos',
  '/api/indexer/[address]/qos-deployments',
  '/api/indexer/[address]/qos-score',
